#Embedded file name: I:/bag/tmp/tw2/res/entities\common\Lib/threadpool.o
...
class WorkRequest:
    ...
    def __str__(self):
        return '<WorkRequest id=%s args=%r kwargs=%r exception=%s>' % (self.requestID,
         self.args,
         self.kwds,
         self.exception)
