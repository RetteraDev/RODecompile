#Embedded file name: I:/bag/tmp/tw2/res/entities\common\Lib\qrcode/main.o
...
class QRCode:
    ...
    def __init__(self, version = None, error_correction = constants.ERROR_CORRECT_M, box_size = 10, border = 4, image_factory = None):
    ...
    def print_tty(self, out = None):
        ...
        out.write('[1;47m' + ' ' * (modcount * 2 + 4) + '[0m\n')
