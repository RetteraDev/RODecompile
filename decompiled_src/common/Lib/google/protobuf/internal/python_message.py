#Embedded file name: I:/bag/tmp/tw2/res/entities\common\Lib\google\protobuf\internal/python_message.o
...
def _AddStaticMethods(cls):
    ...
    def RegisterExtension(extension_handle):
        ...
        if actual_handle is not extension_handle:
            raise AssertionError('Extensions \"%s\" and \"%s\" both try to extend message type \"%s\" with field number %d.' % (extension_handle.full_name,
             actual_handle.full_name,
             cls.DESCRIPTOR.full_name,
             extension_handle.number))
