#Embedded file name: I:/bag/tmp/tw2/res/entities\common\Lib\google\protobuf\internal/type_checkers.o
...
class IntValueChecker(object):
    ...
    def CheckValue(self, proposed_value):
        if not isinstance(proposed_value, (int, long)):
            message = '%.1024r has type %s, but expected one of: %s' % (proposed_value, type(proposed_value), (int, long))
            raise TypeError(message)
...
class UnicodeValueChecker(object):
    ...
    def CheckValue(self, proposed_value):
        if not isinstance(proposed_value, (str, unicode)):
            message = '%.1024r has type %s, but expected one of: %s' % (proposed_value, type(proposed_value), (str, unicode))
            raise TypeError(message)
