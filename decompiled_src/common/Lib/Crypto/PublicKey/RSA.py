#Embedded file name: I:/bag/tmp/tw2/res/entities\common\Lib\Crypto\PublicKey/RSA.o
...
algorithmIdentifier = DerSequence([b('	*†H†÷\r'), DerNull().encode()]).encode()
