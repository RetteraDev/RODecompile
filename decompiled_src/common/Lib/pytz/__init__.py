#Embedded file name: I:/bag/tmp/tw2/res/entities\common\Lib\pytz/__init__.o
"""
...
import sys, datetime, os.path, io
...
def open_resource(name):
    ...
    try:
        import ResMgr
        info = ResMgr.openSection(filename)
        return io.BytesIO(info.asBinary)
    except:
...
common_timezones = ['Africa/Abidjan',
 'Africa/Accra',
 'Africa/Addis_Ababa',
 'Africa/Algiers',
 'Africa/Asmara',
