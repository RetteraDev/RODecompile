#Embedded file name: C:/Users/user/Documents/WORK/roB/build/tmp/tw2/res/entities\client\guis/equipChangeGemLvUpV2Proxy.o
import BigWorld
import gameglobal
import uiConst
import events
...
class EquipChangeGemLvUpV2Proxy(UIProxy):

    def __init__(self, uiAdapter):
        super(EquipChangeGemLvUpV2Proxy, self).__init__(uiAdapter)
        self.widget = None
    ...
    def initUI(self):
        ...
        self.widget.scrollWndList.itemRenderer = 'EquipChangeGemWi_GemItem'
    ...
    def getCurLvUpHintTxt(self, lv):
        gemLvUpHintDict = SCD.data.get('gemLvUpHintDict', {})
        for gemLvUpHintInterval, gemLvUpHintTxt in gemLvUpHintDict.iteritems():
            if gemLvUpHintInterval[0] <= lv <= gemLvUpHintInterval[1]:
                return gemLvUpHintTxt
