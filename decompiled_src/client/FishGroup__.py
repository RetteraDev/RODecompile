#Embedded file name: C:/Users/user/Documents/WORK/roB/build/tmp/tw2/res/entities\client/FishGroup__.o
from gamestrings import gameStrings
import BigWorld, gameglobal, clientcom
from guis import ui
...
class FishGroup(IClient):
    ...
    def _showFishTips(self):
        ...
        if fd:
            ...
            title = gameStrings.TEXT_FISHGROUP_126 % (fishName, fishLv)
            distance = gameStrings.TEXT_FISHGROUP_127 % length
