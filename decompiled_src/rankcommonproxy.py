#Embedded file name: /WORKSPACE/data/entities/client/guis/rankcommonproxy.o
import random
import string
import BigWorld
import const
...
class RankCommonProxy(UIProxy):
    ...
    def genFakeData(self):
        ...
        for i in range(FAKE_DATA_NUM):
            ...
            if i == 0:
                fakeDataTmp[gametypes.TOP_UNIVERSAL_TIP_CONTENT] = '°¡°¡°¡'
            else:
                fakeDataTmp[gametypes.TOP_UNIVERSAL_TIP_CONTENT] = (11111, 'asdfasdf', 1.2333, '\xb0\xa1\xb0\xa1\xb0\xa1')
