#Embedded file name: /WORKSPACE/data/entities/common/lib/yaml/constructor.o
...
class FullConstructor(SafeConstructor):
    ...
    def find_python_name(self, name, mark, unsafe = False):
        ...
        if not hasattr(module, object_name):
            raise ConstructorError('while constructing a Python object', mark, 'cannot find %r in the module %r' % (object_name.encode('utf-8'), module.__name__), mark)
